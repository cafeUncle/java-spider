...
public class Article implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getPersistenceTime() == null ? other.getPersistenceTime() == null : this.getPersistenceTime().equals(other.getPersistenceTime()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getPersistenceTime() == null) ? 0 : getPersistenceTime().hashCode());
